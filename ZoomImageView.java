 ...
 * Copyright(c) 2014 t_saki@serenegiant.com
 *
...
/**
 * ImageView with zoomin/draging/rotating image with touch
 */
public class ZoomImageView extends ImageView {
	
	private static final boolean DEBUG = false;	// TODO for debuging
	...
	*/
	...
	public interface OnStartRotationListener {
		/**
		 * this method is called when rotatin starts.</br>
		 * you will execute feedbaks someting like sound and/or visual effects.
		 * @param view
	...
	/**
	 * get new Bitmap image that currently displed on this view(applied zooming/moving/rotating).
	 * @return
	 */
	...
	/**
	 * get new partial Bitmap image from currently displed on this view(applied zooming/moving/rotating)
